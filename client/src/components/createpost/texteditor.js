...
class CommentTextEditor extends React.Component {
    constructor(props) {
        ...
        this.tePostDefault = 'What are your thoughts?';
        this.handlePostChange = this.handlePostChange.bind(this);
        this.clearDefault = this.clearDefault.bind(this);
        this.handleBlur = this.handleBlur.bind(this);
        this.toggleButton = this.toggleButton.bind(this);
    ...
    render() {
        ...
        const isValid= (this.state.tePost !== this.tePostDefault && this.state.tePost !== '' && !this.state.isSubmitting);
        const buttonClassName = (isValid) ? 'text-editor-button' : 'text-editor-button text-editor-button-disabled';
        ...
        return (
            <div className='text-editor-wrapper'>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className={buttonClassName}>
                        <button style={{backgroundColor: this.props.themeColor[0]}} type='submit' disabled={!isValid}>Comment</button>
                    </div>
                    <p className='text-editor-response'>{ this.state.response }</p>
                </form>
            </div>
